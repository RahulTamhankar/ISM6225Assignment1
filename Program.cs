        ...
        */
        ...
        private static string RemoveVowels(string s)
        {
            try
            {
				...
				// This is a for loop which will iterate all over the input string from 0 to the total length of string
				//it will check whether each letter of input string is a vowel both in upper as well as lower case, if 
				//the string has vowels the if loop does nothing and if it has vowel it will keep on concantenating all the
        ...
        */
        ...
        private static int SumOfUnique(int[] bull_bucks)
        {
            try
            {
                ...
                //This logic will take each element of the sorted array and start
                //comparing each element with the next consecutive element of the same 
                //array. If the element is same then the element will be added to the sum
                //varible. It will also check if i < bull_bucks.Length to make sure that the
